...
public class TableDeck {
    ...
    public TableDeck(){
        ...
        //*In this linked list there is indexes so check winner fucntion going to look at powers of cards and determine who won,
    ...
    public void clearTableDeck(){
        //clears the deck after the each round ends.
    }
}
